...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = "Server=DESKTOP-IKUABEV\\SQLSOFTUNI;Database=TravelAgency;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        public DbSet<TourPackageGuide> TourPackagesGuides { get; set; } = default!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TourPackageGuide>()
                .HasKey(x => new { x.TourPackageId, x.GuideId });
